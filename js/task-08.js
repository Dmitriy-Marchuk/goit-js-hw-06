...
function onFormSubmit(event) {
    ...
    const emailElement = event.currentTarget.elements.email.value;
    const passwordElement = event.currentTarget.elements.password.value;

    if (emailElement == 0 || passwordElement == 0) {
